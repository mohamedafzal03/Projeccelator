			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				...
				<div class="row middle-xs domain-container">
					...
					<div class="col-xs-7 col-sm-7 domain-input">
						<input type="email" name="email" value="" placeholder="technology known" required>
					</div>
				...
				<div class="row middle-xs domain-container">
					...
					<div class="col-xs-7 col-sm-7 domain-input">
						<input type="password" name="pass" value="" placeholder="enter your skills" required>
					</div>
				...
				<div class="row center-xs title">
					...
					<div class="col-xs-7 col-sm-7 domain-input">
						<input type="password" name="pass" value="" placeholder="enter your phone no" required>
					</div>
					...
					<div class="col-xs-7 col-sm-7 domain-input">
						<input type="password" name="pass" value="" placeholder="enter your personal mail-id" required>
					</div>
